...
# Qwen2.5-Math-7B
# raw 5w
# experiment_name=numina-cot-sft-qwen-2.5-math-7b-raw-5w-lr-$lr-0916
...
# our data
# experiment_name=numina-cot-sft-qwen-2.5-math-7b-our-data-lr-$lr-0916
# save_path=checkpoints/$experiment_name
# model_path=../LLMs/Qwen2.5-Math-7B
# train_dataset=../data/Qwen2.5-Math-7B/model_train_datasets.parquet

# ablation
experiment_name=umina-cot-sft-qwen-2.5-math-7b-ablation-lr-$lr-0916
save_path=checkpoints/$experiment_name
model_path=../LLMs/Qwen2.5-Math-7B

train_dataset=../data/Qwen2.5-Math-7B/ablation/ablation_data.parquet
...
# experiment_name=numina-cot-sft-Meta-Llama-3.1-8B-raw-5w-lr-$lr-0913
# save_path=checkpoints/$experiment_name
...
# # our data
# experiment_name=numina-cot-sft-Meta-Llama-3.1-8B-our-data-lr-$lr-0913
# save_path=checkpoints/$experiment_name
# model_path=../LLMs/Meta-Llama-3.1-8B
...
# experiment_name=numina-cot-sft-Meta-Llama-3.1-8B-Instruct-raw-5w-lr-$lr-0916
# save_path=checkpoints/$experiment_name
...
# our data
# experiment_name=numina-cot-sft-Meta-Llama-3.1-8B-Instruct-our-data-lr-$lr-0916
# save_path=checkpoints/$experiment_name
# model_path=../LLMs/Meta-Llama-3.1-8B-Instruct
